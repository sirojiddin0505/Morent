...
const Header = () => {
  return (
    <section>
      <div className="container mx-auto flex justify-between items-center px-8 gap-4 bg-white/100 border">
        ...
        <div className='flex  items-center gap-4'>
          <FaHeart className='text-[26px] text-[red] cursor-pointer active:scale-90 duration-100'/>
          <IoIosNotifications className='text-[32px] text-gray-600 cursor-pointer active:scale-90 duration-100'/>
          <IoIosSettings className='text-[32px] text-gray-600 cursor-pointer active:scale-90 duration-100'/>
