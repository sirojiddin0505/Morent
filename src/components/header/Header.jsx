...
const Header = () => {
  ...
  return (
    <section>
      <div className="container mx-auto flex justify-between items-center py-2 px-8 gap-4 bg-white/100">
        <div className='flex gap-4 lg:gap-20 items-center'>
          <h1 className='text-blue-700 text-[24px] md:text-[32px] font-[700]'>MORENT</h1>
          <div className='hidden md:w-[350px] lg:w-[410px] sm:flex items-center py-1.5 border-gray-500 px-4 gap-2 border rounded-full'><FaSearch className='text-gray-500 text-[20px]'/><input type="text" className='w-full text-gray-800 outline-none' placeholder='Search'/></div>
        </div>
        <div className='flex items-center gap-2 md:gap-4'>
          ...
          <img src={person_img} className='rounded-full w-[50px] h-[50px] cursor-pointer hidden md:flex' alt="user_img" />
      ...
      <div className={`fixed top-0 right-0 h-full w-80 bg-gray-200 shadow-lg z-50 transform transition-transform duration-350 ${openModal ? "translate-x-0" : "translate-x-full"}`}>
        ...
        <div className='max-w-[300px] h-[350px] py-4 pl-4 flex flex-col space-y-3'>
          <div className='flex items-center justify-between gap-2'>
            <div className='w-[230px] flex items-center py-1.5 border-gray-500 px-4 gap-2 border rounded-full'><FaSearch className='text-gray-500 text-[20px]'/><input type="text" className='w-full text-gray-800 outline-none' placeholder='Search'/></div>
